...
pub async fn get_member_financials(
    coop_id: String,
) -> Result<MemberFinancials, ServerFnError> {
    ...
    get_member_financials_logic(&state.subgraph, &state.blockchain_service, &coop_id, wallet)
        .await
