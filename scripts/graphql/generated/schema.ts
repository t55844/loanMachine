...
export class WalletApprovalProposedEvent extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save WalletApprovalProposedEvent entity without an ID",
    );
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type WalletApprovalProposedEvent must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("WalletApprovalProposedEvent", id.toString(), this);
    }
  }

  static loadInBlock(id: string): WalletApprovalProposedEvent | null {
    return changetype<WalletApprovalProposedEvent | null>(
      store.get_in_block("WalletApprovalProposedEvent", id),
    );
  }

  static load(id: string): WalletApprovalProposedEvent | null {
    return changetype<WalletApprovalProposedEvent | null>(
      store.get("WalletApprovalProposedEvent", id),
    );
  }
...
export class WalletApprovalModeratorSignedEvent extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save WalletApprovalModeratorSignedEvent entity without an ID",
    );
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type WalletApprovalModeratorSignedEvent must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("WalletApprovalModeratorSignedEvent", id.toString(), this);
    }
  }

  static loadInBlock(id: string): WalletApprovalModeratorSignedEvent | null {
    return changetype<WalletApprovalModeratorSignedEvent | null>(
      store.get_in_block("WalletApprovalModeratorSignedEvent", id),
    );
  }

  static load(id: string): WalletApprovalModeratorSignedEvent | null {
    return changetype<WalletApprovalModeratorSignedEvent | null>(
      store.get("WalletApprovalModeratorSignedEvent", id),
    );
  }
  ...
  get moderatorId(): Bytes {
    let value = this.get("moderatorId");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBytes();
  ...
  set moderatorId(value: Bytes) {
    this.set("moderatorId", Value.fromBytes(value));
  }
...
export class AccessCodeRotatedEvent extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save AccessCodeRotatedEvent entity without an ID",
    );
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type AccessCodeRotatedEvent must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("AccessCodeRotatedEvent", id.toString(), this);
    }
  }

  static loadInBlock(id: string): AccessCodeRotatedEvent | null {
    return changetype<AccessCodeRotatedEvent | null>(
      store.get_in_block("AccessCodeRotatedEvent", id),
    );
  }

  static load(id: string): AccessCodeRotatedEvent | null {
    return changetype<AccessCodeRotatedEvent | null>(
      store.get("AccessCodeRotatedEvent", id),
    );
  }
...
export class WithdrawalRequestedEvent extends Entity {
  ...
  static loadInBlock(id: string): WithdrawalRequestedEvent | null {
    return changetype<WithdrawalRequestedEvent | null>(
      store.get_in_block("WithdrawalRequestedEvent", id),
    );
  }
  ...
  get executableAfter(): BigInt {
    let value = this.get("executableAfter");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set executableAfter(value: BigInt) {
    this.set("executableAfter", Value.fromBigInt(value));
  }
...
export class WithdrawalExecutedEvent extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save WithdrawalExecutedEvent entity without an ID",
    );
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type WithdrawalExecutedEvent must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("WithdrawalExecutedEvent", id.toString(), this);
    }
  }

  static loadInBlock(id: string): WithdrawalExecutedEvent | null {
    return changetype<WithdrawalExecutedEvent | null>(
      store.get_in_block("WithdrawalExecutedEvent", id),
    );
  }

  static load(id: string): WithdrawalExecutedEvent | null {
    return changetype<WithdrawalExecutedEvent | null>(
      store.get("WithdrawalExecutedEvent", id),
    );
  }
...
export class WithdrawalBlockedEvent extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save WithdrawalBlockedEvent entity without an ID",
    );
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type WithdrawalBlockedEvent must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("WithdrawalBlockedEvent", id.toString(), this);
    }
  }

  static loadInBlock(id: string): WithdrawalBlockedEvent | null {
    return changetype<WithdrawalBlockedEvent | null>(
      store.get_in_block("WithdrawalBlockedEvent", id),
    );
  }

  static load(id: string): WithdrawalBlockedEvent | null {
    return changetype<WithdrawalBlockedEvent | null>(
      store.get("WithdrawalBlockedEvent", id),
    );
  }
  ...
  set blocker(value: Bytes) {
    this.set("blocker", Value.fromBytes(value));
  }
...
export class WithdrawalCancelledEvent extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save WithdrawalCancelledEvent entity without an ID",
    );
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type WithdrawalCancelledEvent must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("WithdrawalCancelledEvent", id.toString(), this);
    }
  }

  static loadInBlock(id: string): WithdrawalCancelledEvent | null {
    return changetype<WithdrawalCancelledEvent | null>(
      store.get_in_block("WithdrawalCancelledEvent", id),
    );
  }

  static load(id: string): WithdrawalCancelledEvent | null {
    return changetype<WithdrawalCancelledEvent | null>(
      store.get("WithdrawalCancelledEvent", id),
    );
  }
